...
function Menuvideo({ searchQuery, setSearchQuery, filteredItems }) {
      ...
      <div className="relative">
        ...
        <div className="container m-auto px-6 pt-32 md:px-12 lg:pt-[4.8rem] lg:px-7 w-full absolute top-0 left-0 right-0 bottom-0 flex items-center">
          <div className="flex flex-col lg:w-6/12">
            ...
            {searchQuery && ( // Render search results only when searchQuery is not empty
              <div className="search-results cursor-pointer font-shadows-into-light bg-white p-2 flex gap-5 flex-col rounded-lg">
